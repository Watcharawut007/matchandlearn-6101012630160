...
urlpatterns = [
    ...
    path('<int:user_id>/personal_profile.html/', views.personal_profile, name ='your_subject'),
    ...
    path('<int:user_id>/profile_accept/', views.profile_accept_or_decline, name="profile_accept"),
    path('<int:user_id>/students_list/', views.tutor_student_list, name="students_list"),
